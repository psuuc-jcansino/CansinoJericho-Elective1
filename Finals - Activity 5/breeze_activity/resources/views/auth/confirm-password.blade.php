<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.confirm') }}" class="max-w-md mx-auto bg-white dark:bg-gray-900 p-8 rounded-lg shadow-md border border-red-600 dark:border-red-500 space-y-6">
        @csrf
